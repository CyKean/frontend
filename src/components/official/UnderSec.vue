<template>
    <h5 class="text-left font-semibold text-lg">UNDERSECRETARIES</h5>
    ...
    methods: {
        ...
        async fetchUnderSecData() {
            ...
            try {
                ...
                console.error('Failed to fetch HEA data:', e);
            }
        },
        ...
        saveCardsToLocalStorage() {
            localStorage.setItem('undersecretaryCards', JSON.stringify(this.cards)); 
        },
        loadCardsFromLocalStorage() {
            const storedCards = localStorage.getItem('undersecretaryCards'); 
            if (storedCards) {
