<template>
    <h5 class="text-left font-semibold text-lg">ASSISTANT SECRETARIES</h5>
...
export default {
    ...
    methods: {
        ...
        saveCardsToLocalStorage() {
            localStorage.setItem('assistantSecretaryCards', JSON.stringify(this.cards)); 
        },
        loadCardsFromLocalStorage() {
            const storedCards = localStorage.getItem('assistantSecretaryCards'); 
            if (storedCards) {
